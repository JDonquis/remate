...
<body>
    <div class="ticket">
                                ...
                                <td>
                                    @if (isset($horse['additional_pot']) && $horse['additional_pot'] > 0)
                                        <div>
                                            ...
                                            <div class="pote-info">
                                                + Bono 5 Tablas: ${{ number_format($horse['additional_pot'], 2) }}
                                            </div>
                                            <div>
                                                <strong>Total:
        ...
        <div class="info total" style="border-top: 2px solid #000; padding-top: 8px;">
            <strong>Total Apostado:</strong> VES.{{ number_format($totalBet, 2) }}<br>
        </div>
